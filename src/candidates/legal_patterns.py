...
# through 15+ court decisions and noting which phrases appear in "useful" chunks
# vs "noise" chunks. I extracted them here to makes maintenance easier.
#
...
# the debtor did wrong. See reranker.py for detailed comments about each pattern.
...
BREACH_PATTERNS = [
    ...
    (re.compile(r'(?i)predmetom\s+(konania|sporu)', re.UNICODE), 1),
...
# ==========================================
# The legal arguments the court used. Most important for thesis extraction.
